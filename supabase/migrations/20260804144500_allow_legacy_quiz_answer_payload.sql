-- Keep the currently deployed batch client working until the per-question client is deployed.
-- New clients send answer; older clients only send news_id and correct.
