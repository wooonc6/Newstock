-- 2026-08-06: make ranking candidates include every user with active holdings.
-- Next.js still calculates live market value with Yahoo Finance before final sorting.
